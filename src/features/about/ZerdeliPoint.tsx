    ...
    <section id="zerdeli-point">
      <Container>
        <div className="relative max-md:pb-[200px] bg-gradient-to-r from-[#CBF5BF] z-0 to-[#FFE999] rounded-2xl p-6 md:p-10">
          ...
          />
          <h2 className="mb-2 text-3xl md:text-4xl font-medium ">{t('zerdeliPoint.title')}</h2>
          <p className="max-md:text-sm mb-6 md:mb-10">{t('zerdeliPoint.subtitle')}</p>
            ...
            <li className="flex items-center gap-3">
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: t('zerdeliPoint.bullets.bestStudents').replace(/\n/g, '<br />'),
                }}
              />
            </li>
            <li className="flex items-center gap-3">
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: t('zerdeliPoint.bullets.activeStudents').replace(/\n/g, '<br />'),
                }}
              />
            </li>
            <li className="flex items-center gap-3">
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: t('zerdeliPoint.bullets.progressStudents').replace(/\n/g, '<br />'),
                }}
              />
            </li>
            <li className="flex items-center gap-3">
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: t('zerdeliPoint.bullets.homeworkStudents').replace(/\n/g, '<br />'),
                }}
              />
            </li>
          </ul>
