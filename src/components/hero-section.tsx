  ...
  return (
    <div className="relative items-center flex z-0 flex-col min-h-[calc(100vh-64px)] bg-white overflow-hidden">
      <div className="space-y-6 mt-8 md:my-[200px]">
        <h1 className="text-4xl font-agenor text-center sm:text-7xl">
          От знаний
          <br />к достижениям
        </h1>
        <p className="px-4 text-lg text-center sm:text-xl opacity-80">
      ...
      <div className="px-4 flex flex-col max-md:absolute max-md:bottom-8 items-center space-y-4">
        <Image src="/sun.png" width={45} height={45} alt="sun" />
      ...
      <Image
        className="absolute max-sm:w-[240px] -z-10 right-0 top-1/2 -translate-y-1/2"
        src="/dombyra.png"
        width={360}
        height={360}
        alt="dombyra"
